          ...
          <div className="flex items-center justify-between">
            <div className="flex items-center justify-start">
              ...
              <a href="#" className="text-xl font-bold flex items-center lg:ml-2.5">
                <Image width={70} height={70} src="/image/logo/1.png" className="" alt="Windster Logo" />
                <span className="self-center whitespace-nowrap">Fortonight</span>
              </a>
            ...
            <div className="flex items-center">
              ...
              <div className="hidden lg:flex items-center">
                <span className="text-base font-normal text-gray-500 mr-5">Xin Chào : ADMIN ❤️</span>
                <div className="-mb-1">
