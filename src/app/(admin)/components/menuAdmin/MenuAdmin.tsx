...
const items: MenuItem[] = [
    getItem('Người dùng', 'sub1', <MailOutlined />, [
        getItem(<Link href={'/admin/list-users'}>Danh sách người dùng</Link>, '1'),
        getItem('Option 2', '2'),
        getItem('Option 3', '3'),
        getItem('Option 4', '4'),
    ]),
    getItem('Quản lý phim', 'sub2', <AppstoreOutlined />, [
        getItem(<Link href={'/admin/list-movies'}>Danh sách phim</Link>, '5'),
        getItem(<Link href={'/admin/genre'}>Thể loại phim</Link>, '6'),
        getItem('Submenu', 'sub3', null, [getItem('Option 7', '7'), getItem('Option 8', '8')]),
    ]),
    getItem('Quản lý rạp', 'sub4', <SettingOutlined />, [
        getItem(<Link href={'/admin/cinema/list'}>Lịch chiếu</Link>, '10'),
...
export default function MenuAdmin() {
    ...
    return (
        <aside id="sidebar" className="overflow-y-hidden overflow-hidden fixed hidden z-20 h-full top-0 left-0 pt-16 flex lg:flex flex-shrink-0 flex-col w-64 transition-width duration-75" aria-label="Sidebar">
            <div className="relative flex-1 flex flex-col min-h-0 border-r border-gray-200 bg-white pt-0 overflow-hidden overflow-y-hidden">
                <div className="flex-1 flex flex-col pt-5 pb-4 overflow-y-auto overflow-hidden overflow-y-hidden">
                    <Menu
                        mode="inline"
                        openKeys={openKeys}
